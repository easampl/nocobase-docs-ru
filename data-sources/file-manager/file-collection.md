...
Файлы — это записи в специально структурированной коллекции, известной как коллекция файлов. Она используется для хранения метаданных файлов и может управляться через Файловый менеджер.
