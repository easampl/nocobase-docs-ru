...
Триггер "События коллекции" отслеживает события создания, обновления и удаления данных в коллекции. 

Если происходит операция с данными в этой коллекции, и она соответствует заданным условиям, запускается соответствующий рабочий процесс. Например, это может быть списание товаров со склада после создания нового заказа или ожидание ручной проверки после добавления нового комментария.
