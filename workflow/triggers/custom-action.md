...
Если переданы связанные данные, они также будут перезаписаны. Будьте особенно осторожны при обработке входящих данных, если настроена предварительная загрузка связанных элементов, чтобы избежать неожиданной перезаписи.
:::
