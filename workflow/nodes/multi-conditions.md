...
В интерфейсе настройки рабочего процесса нажмите кнопку («+»), чтобы добавить узел «Множественные условия»:
...
:::info{title=Примечание}
Независимо от выбранного способа обработки, если ни одно из условий не выполняется, процесс перейдет в ветвь «Иначе» для выполнения узлов внутри нее.
:::
