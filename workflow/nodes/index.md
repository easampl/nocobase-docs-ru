...
Рабочий процесс обычно состоит из нескольких связанных шагов. Каждый такой шаг называется узел и является базовой логической единицей в процессе. Как и в языке программирования, разные типы узлов представляют разные инструкции, которые определяют их поведение. Когда рабочий процесс запускается, система последовательно входит в каждый узел и выполняет его инструкции.
