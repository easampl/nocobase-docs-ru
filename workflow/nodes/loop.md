...
В интерфейсе настройки **рабочего процесса** нажмите кнопку («+»), чтобы добавить узел «Цикл»:
...
Начиная с версии `v1.4.0-beta`, если узел внутри цикла не выполняется (из-за несоблюдения условий, ошибок и т. д.), можно настроить дальнейший ход **рабочего процесса**. Поддерживаются три способа обработки:
