...
Узел используется для отправки пользовательских сообщений из рабочего процесса клиенту, инициировавшему действие, в определённых типах рабочих процессов.
...
В поддерживаемых типах рабочих процессов вы можете добавить узел «Ответное сообщение» в любом месте рабочего процесса. Нажмите кнопку («+») в рабочем процессе, чтобы добавить узел «Ответное сообщение».
