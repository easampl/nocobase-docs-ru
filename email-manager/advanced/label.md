...
В правой части деталей письма вы можете **выбирать метки** для писем.
...
При создании новой метки она будет отмечена по умолчанию, либо вы можете вручную выбрать другие метки.

![](https://static-docs.nocobase.com/email-manager/Email-10-31-2025_06_06_PM%20(1).png)

В списке писем вы можете видеть соответствующие метки для писем.
