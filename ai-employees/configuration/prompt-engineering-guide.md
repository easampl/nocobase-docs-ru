# ИИ-агент  · Руководство по проектированию запросов
...
Описание — это «описание должностных обязанностей» для ИИ-агента. Она напрямую определяет стиль, границы и качество выходных результатов.
